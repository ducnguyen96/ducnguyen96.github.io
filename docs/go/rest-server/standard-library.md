...
Điều dễ nhận thấy nhất là ta có thể cải thiện phần lặp đi lặp lại render JSON vào HTTP response. Chi tiết bạn có thể xem [ở đây](https://github.com/ducnguyen96/ducnguyen96.github.io/tree/master/static/code/docs/go/rest-server/stdlib-factorjson). Dưới đây là điểm thay đổi chính:
