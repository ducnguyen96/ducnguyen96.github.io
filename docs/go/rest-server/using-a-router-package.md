...
Vì nó là 1 package với mục tiêu cụ thể duy nhất, nên cách sử dụng của nó khá đơn giản. Bạn có thể xem phiên bản task server sử dụng `gorilla/mux` cho routing [ở đây](https://github.com/ducnguyen96/ducnguyen96.github.io/tree/master/static/code/docs/go/rest-server/gorilla). Dưới đây là cách routes được defined:
