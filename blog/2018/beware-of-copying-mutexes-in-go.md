...
Giả sử ta có một `struct chứa một map và ta muốn thay đổi map trong method của struct ấy. Xem [ví dụ sau](https://github.com/eliben/code-for-blog/tree/master/2018/go-copying-mutex):
