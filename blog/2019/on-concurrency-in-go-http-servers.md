...
The simplest solution is to serialize all map accesses using a mutex. Dưới đây là một đoạn code trích từ [ví dụ hoàn chỉnh](https://github.com/ducnguyen96/ducnguyen96.github.io/tree/master/static/code/blog/gohttpconcurrency/mutex-server.go):
...
Thay vì sử dụng mutexes thì ta có thể dùng channels để đồng bộ hóa truy cập đến dữ liệu được chia sẻ. [Code mẫu này](https://github.com/ducnguyen96/ducnguyen96.github.io/tree/master/static/code/blog/gohttpconcurrency/channel-manager-server.go) thay thế mutexes bằng channels. Bắt đầu bằng việc define một "counter manager" là một background goroutine truy cập tới một closure - nơi lưu trữ data.
